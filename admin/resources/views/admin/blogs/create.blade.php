    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blog_title') ? 'is-invalid' : '' }}" type="text" name="blog_title" id="blog_title" value="{{ old('blog_title', '') }}" required>
            ...
            <div class="form-group">
                <label class="required" for="blog_image">{{ trans('cruds.blog.fields.blog_image') }}</label>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/blogs/ckmedia', true);

...
@section('title')
    FOOD WASTE RECYCLING INDUSTRY | Pomilly East African Limited
@endsection
                                ...
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/29.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/30.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/31.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/32.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/33.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            ...
                                            <div class="single-course mb-70">
                                                <div class="course-img">
                                                    <img src="{{ asset('assets/img/services/34.jpg')}}" height="320px" alt="">
                                                </div>
                                                <div class="course-caption">
                                                    <div class="course-cap-top">

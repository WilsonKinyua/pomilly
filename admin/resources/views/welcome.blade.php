...
@section('title')
    ENVIRONMENTAL, OCCUPATIONAL SAFETY & PUBLIC HEALTH CONSULTANCY | Pomilly East African Limited | Homepage
@endsection
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="hero__caption">
                                ...
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="{{ route('home.contact')}}" class="btn hero-btn" data-animation="fadeInLeft" data-delay=".8s">Contact Us</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 ">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <a href="{{ route('company.aboutus')}}" class="btn">More About Us</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <!-- about-img -->

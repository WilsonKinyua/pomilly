    ...
    <div class="index-content">
        <div class="container">
            <div class="row">
                ...
                <a href="food-insecurity">
                    <div class="col-lg-4">
                        <div class="card">
                            <img class="img-responsive" src="assets/img/services/43.jpg">
                            ...
                            <a href="food-insecurity" class="blue-button">Read More</a>
                        </div>
                    </div>
                </a>

                <a href="food-security">
                    <div class="col-lg-4" style="margin-top: 4px;">
                        <div class="card">
                            <img class="img-responsive" src="assets/img/services/44.jpg">
                            ...
                            <a href="food-security" class="blue-button">Read More</a>
                        </div>
                    </div>
                </a>

                <a href="indoor-vertical-farming">
                    <div class="col-lg-4" style="margin-top: 4px;">
                        <div class="card">
                            ...
                            <a href="indoor-vertical-farming" class="blue-button">Read More</a>
                        </div>
                    </div>
                </a>
            </div>

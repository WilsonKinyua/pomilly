...
Route::get('/blog', 'HomePageController@blog')->name('blog.blog');
Route::get('/blog/food-insecurity', 'HomePageController@b1')->name('blog.food-insecurity');
Route::get('/blog/food-security', 'HomePageController@b2')->name('blog.food-security');
Route::get('/blog/indoor-vertical-farming', 'HomePageController@b3')->name('blog.indoor-vertical-farming');

...
if (isset($_POST['send_mess'])) {
    ...
    $conn->query("INSERT INTO `comments` (`name`,`email`,`phone`,`comment`,`post`,`status`,`created_at`) VALUES ('$name','$email','$phone','$comment','indoor-vertical-farming','0','$date')") or die($conn->error);
